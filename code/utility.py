...
def create_agent(algorithm_name, observation_space_size, action_space_size):
  if algorithm_name == "deep-q-learning":
    ...
    return agents.PrioritizedDeepQLearningAgent(observation_space_size, action_space_size)
  elif algorithm_name == "dueling-deep-q-learning":
    return agents.DuelingDeepQLearningAgent(observation_space_size, action_space_size)
  elif algorithm_name == "zero-baseline-vanilla-policy-gradient":
    return agents.ZeroBaselineVanillaPolicyGradientAgent(observation_space_size, action_space_size)
  elif algorithm_name == "state-value-baseline-vanilla-policy-gradient":
    return agents.StateValueBaselineVanillaPolicyGradientAgent(observation_space_size, action_space_size)
  elif algorithm_name == "advantage-actor-critic":
    return agents.AdvantageActorCriticAgent(observation_space_size, action_space_size)
  else:
    return None
...
def format_algorithm_name_for_plot(algorithm_name):
  if algorithm_name == "deep-q-learning":
    ...
    return "Dueling Deep Q-learning"
  elif algorithm_name == "zero-baseline-vanilla-policy-gradient":
    return "Zero Baseline Vanilla Policy Gradient"
  elif algorithm_name == "state-value-baseline-vanilla-policy-gradient":
    return "State Value Baseline Vanilla Policy Gradient"
  elif algorithm_name == "advantage-actor-critic":
    return "Advantage Actor Critic"
  else:
    return None
...
def parse_input_arguments(algorithm_name_choices=("deep-q-learning", "double-deep-q-learning",
                                                  "prioritized-deep-q-learning", "dueling-deep-q-learning",
                                                  "zero-baseline-vanilla-policy-gradient",
                                                  "state-value-baseline-vanilla-policy-gradient",
                                                  "advantage-actor-critic"),
                          environment_name_choices=("cart-pole", "acrobot"),
