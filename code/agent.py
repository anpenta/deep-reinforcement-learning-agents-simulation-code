...
class Agent:
  ...
  def __init__(self):
    ...
    self._epsilon_decay_steps = 1000000
    self._replay_memory_capacity = 1000000
    self._learning_rate = 0.001
    self._batch_size = 32
    self._target_update_frequency = 10000
    ...
    self._model = dqn.DQN().to(self._device)
    self._target_model = dqn.DQN().to(self._device)
